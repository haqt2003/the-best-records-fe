<template>
  ...
  >
    <div
      class="absolute top-1/2 -translate-y-1/2 left-1/2 sm:left-auto sm:-translate-x-0 -translate-x-1/2 sm:right-[15%] py-8 px-10 sm:py-12 sm:px-14 bg-white rounded-xl w-[88%] sm:w-auto"
    >
